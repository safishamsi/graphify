...
> **nanobot platform:** Multi-agent support is still early on nanobot. Extraction runs sequentially — you read and extract each file yourself. This is slower than parallel platforms but fully reliable.

Print: `"Semantic extraction: N files (sequential — nanobot)"`
...
**Step B2 - Sequential extraction (nanobot)**
