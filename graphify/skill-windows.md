...
'@ | Out-File -FilePath graphify-out/.graphify_step_1_ensure_graphify_is_installed_2.py -Encoding utf8
python graphify-out/.graphify_step_1_ensure_graphify_is_installed_2.py
Remove-Item -ErrorAction SilentlyContinue graphify-out/.graphify_step_1_ensure_graphify_is_installed_2.py
```
...
& (Get-Content graphify-out/.graphify_python) graphify-out/.graphify_step_2_detect_files_3.py > graphify-out/.graphify_detect.json
