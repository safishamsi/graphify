...
from graphify.detect.ignore import (
...
def _rebuild_code(
    ...
    *,
    ...
    try:
        ...
        from graphify.detect.core import detect
        ...
        if no_cluster:
            ...
            try:
                from graphify.detect.core import save_manifest
        ...
        if not no_change:
            try:
                to_html(G, communities, str(out / "graph.html"), community_labels=labels or None, node_limit=_viz_node_limit())
                html_written = True
        ...
        if callflow_files and not no_change:
            try:
                from graphify.export.callflow import write_callflow_html
