...
- Check that `$GOUT/.graphify_chunk_N.json` exists on disk — this is the success signal
...
"
rm -f $GOUT/.graphify_detect.json $GOUT/.graphify_extract.json $GOUT/.graphify_ast.json $GOUT/.graphify_semantic.json $GOUT/.graphify_analysis.json $GOUT/.graphify_labels.json $GOUT/.graphify_chunk_*.json $GOUT/.graphify_incremental.json $GOUT/.graphify_transcripts.json $GOUT/.graphify_old.json
