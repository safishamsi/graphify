...
class TestFetchWorktrees:
    def test_normal_case_maps_branch_to_path(self):
        ...
        with patch("graphify.prs.github.subprocess.run", return_value=mock_result):
    ...
    def test_subprocess_failure_returns_empty_dict(self):
        with patch(
            "graphify.prs.github.subprocess.run",
...
class TestDetectDefaultBranch:
    ...
    def test_falls_back_to_git_symbolic_ref(self):
        ...
        with patch("graphify.prs.github._gh", return_value=None), patch(
            "graphify.prs.github.subprocess.run", return_value=mock_result
        ):
    ...
    def test_gh_returns_empty_dict_falls_back(self):
        ...
        with patch("graphify.prs.github._gh", return_value={}), patch(
            "graphify.prs.github.subprocess.run", return_value=mock_result
        ):
