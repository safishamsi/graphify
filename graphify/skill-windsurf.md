...
> **Windsurf platform:** Windsurf's parallel agents (Wave 13) run in separate worktrees — they cannot be spawned programmatically from within a single Cascade session. Extraction runs sequentially — you read and extract each file yourself. This is slower than parallel platforms but fully reliable.

Print: `"Semantic extraction: N files (sequential — Windsurf)"`
...
**Step B2 - Sequential extraction (Windsurf)**
