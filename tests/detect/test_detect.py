...
from graphify.detect import classify_file, count_words, detect, detect_incremental, save_manifest, FileType, _is_sensitive
...
def test_detect_converts_google_workspace_shortcuts_when_enabled(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("graphify.detect.core.convert_google_workspace_file", fake_convert)
